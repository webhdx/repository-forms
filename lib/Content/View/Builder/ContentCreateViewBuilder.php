...
class ContentCreateViewBuilder implements ViewBuilder
{
    ...
    public function buildView(array $parameters)
    {
        ...
        $contentCreateData = $this->resolveContentCreateData($contentType, $location, $language);
        $form = $this->resolveContentCreateForm($contentCreateData, $language);
    ...
    private function resolveContentCreateData(
        ...
        return $contentCreateMapper->mapToFormData(
            ...
            [
                'mainLanguageCode' => $language->languageCode,
                'parentLocation' => $this->repository->getLocationService()->newLocationCreateStruct(
                    $location->id
                ),
            ]
        );
