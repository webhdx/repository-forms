...
class ContentTypeGroupFormProcessor implements EventSubscriberInterface
{
    ...
    {
        /** @var \EzSystems\EzPlatformAdminUi\RepositoryForms\Data\ContentTypeGroup\ContentTypeGroupUpdateData|\EzSystems\EzPlatformAdminUi\RepositoryForms\Data\ContentTypeGroup\ContentTypeGroupCreateData $data */
        $data = $event->getData();
        if ($data->isNew()) {
